...
Usage:
  # Generate patched script only (no training):
  python3 bytedance_runner.py --no-run --sprint-src /path/to/sprint1_Main.py

  # Generate and run:
  python3 bytedance_runner.py --sprint-src /path/to/sprint1_Main.py \\
      --data-dir /path/to/bytedance/pipeline_data \\
      --output-dir /path/to/bytedance/results
"""
