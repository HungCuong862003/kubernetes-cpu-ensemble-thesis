"""
Task 1: Chronos-Bolt Zero-Shot Benchmark
Datasets: Alibaba | Bitbrains | ByteDance
Horizons: 10min | 30min | 60min | 120min

Colab Pro+ setup:
  Cell 1: !pip install chronos-forecasting -q
  Cell 2: from google.colab import drive; drive.mount('/content/drive')
  Cell 3: %run /content/drive/MyDrive/thesis_upgrade/task1_chronos_benchmark.py
"""
